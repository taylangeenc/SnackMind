    ...
    public partial class SnackMindCafe : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Branches", t => t.BranchRef, cascadeDelete: false)
                .ForeignKey("dbo.Firms", t => t.FirmRef, cascadeDelete: false)
                .ForeignKey("dbo.LogTypes", t => t.LogTypeRef, cascadeDelete: false)
                .ForeignKey("dbo.Users", t => t.UserRef, cascadeDelete: false)
                .Index(t => t.FirmRef)
                .Index(t => t.BranchRef)
                .Index(t => t.UserRef)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Logs", "UserRef", "dbo.Users");
            DropForeignKey("dbo.Logs", "LogTypeRef", "dbo.LogTypes");
            DropForeignKey("dbo.Logs", "FirmRef", "dbo.Firms");
            DropForeignKey("dbo.Logs", "BranchRef", "dbo.Branches");
            ...
            DropIndex("dbo.Logs", new[] { "LogTypeRef" });
            DropIndex("dbo.Logs", new[] { "UserRef" });
            DropIndex("dbo.Logs", new[] { "BranchRef" });
            DropIndex("dbo.Logs", new[] { "FirmRef" });
